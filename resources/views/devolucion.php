...
<head>
    ...
    <link rel="stylesheet" href="<?= web_resource("css/styledevolucion.css") ?>">
</head>
<body>
<!--- header start --->
<header>
...
<main>
    <!--- buscar start --->
    <section>
        <p>Esta sección se explicará el envió, las devoluciones y como lavar las camisas de una manera correcta</p>
    </section>
    <!--- buscar end --->
    <!--- contact start --->

...
<main>
    <!--- carrito start --->
    <section>
        <p>Esta es la sección estarán todos los productos que el usuario tiene en su carrito de compras</p>
    </section>
    <!--- carrito end --->
    <!--- contact start --->
